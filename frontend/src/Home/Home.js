...
const DIETE = [
    ...
    },
    {
      ...
      preparation: "Add the mozzarella to a bowl and microwave for 1-2 minutes, until melted. Allow the mozzarella to cool for 30 seconds. With a spatula, gently fold the egg yolk into the cheese. Turn the mixture out onto a parchment paper-lined baking sheet. Place another piece of parchment paper on top of the dough and press down with your hand until thin. Remove the top piece of parchment and cut the dough into thin strips. Place the “pasta” on a rack and refrigerate for four hours or overnight. Place the “pasta” in boiling water for one minute. Drain into a colander and run cool water over the pasta to prevent sticking. Serve with your favorite sauce and toppings.",
    ...
    },
    {
      ...
      preparation: "Heat sesame oil in a skillet, and cook garlic until softened. Add the chicken, salt, and pepper, and sauté for 5 minutes. Add the carrots and broccoli, and sauté until tender. Add the rice, soy sauce, and peas, and mix thoroughly.",
      picture: <img src = {poza5} alt = "Dieta 5"/>
    }
  ];

const HomePage = () =>{
    const [afisare,setAfisare] = useState("Home");

    function setDisplayHome(){
        setAfisare("Home");
    }

    function setDisplayDiete(){
        setAfisare("Diete");
    }
        ...
        <div>
            ...
            >
                ...
                <div id = "menuPrincipal" 
                    style = {{display:"flex", justifyContent:"space-around", flexDirection:"row"}}
                >
                    <button onClick = {setDisplayHome}>Home</button>
                    <button onClick = {setDisplayDiete}>Diets</button>
                </div>
                <div></div>
            </div>
            <br/><br/>
